 ...
 * @author Arsiela
 */
public class Service_Advisor_Master implements GRecord {
    ...
    Model_Service_Advisor poModel;

    JSONObject poJSON;

    public Service_Advisor_Master(GRider foAppDrver, boolean fbWtParent, String fsBranchCd) {
        poModel = new Model_Service_Advisor(foAppDrver);
    ...
    public JSONObject newRecord() {
        ...
        try {
            ...
            poModel = new Model_Service_Advisor(poGRider);
    ...
    public JSONObject saveRecord() {
        poJSON = new JSONObject();
        ValidatorInterface validator = ValidatorFactory.make(ValidatorFactory.TYPE.Service_Advisor, poModel);
    ...
    public JSONObject deactivateRecord(String fsValue) {
        ...
        if (poModel.getEditMode() == EditMode.UPDATE) {
            try {
                ...
                if (!cancelform.loadCancelWindow(poGRider, poModel.getClientID(), poModel.getClientID(), "SERVICE ADVISOR")) {
                    poJSON.put("result", "error");
                ...
                Logger.getLogger(Service_Advisor_Master.class.getName()).log(Level.SEVERE, null, ex);
            }
        } else {
            poJSON = new JSONObject();
            poJSON.put("result", "error");
    ...
    public JSONObject searchRecord(String fsValue, boolean fbByActive) {
        ...
        System.out.println("SEARCH SERVICE ADVISOR: " + lsSQL);
    ...
    @Override
    public Model_Service_Advisor getModel() {
        return poModel;
    }
    ...
    public JSONObject validateExistingSA() {
        poJSON = new JSONObject();
        String lsClientID = "";
        String lsCompnyNm = "";
        try {
