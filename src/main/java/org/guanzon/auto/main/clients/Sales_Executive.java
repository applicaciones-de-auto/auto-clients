 ...
 * @author Arsiela
 */
public class Sales_Executive implements GRecord{
    GRider poGRider;
    boolean pbWthParent;
    String psBranchCd;
    boolean pbWtParent;
    ...
    Sales_Executive_Master poController;
    
    public Sales_Executive(GRider foAppDrver, boolean fbWtParent, String fsBranchCd){
        poController = new Sales_Executive_Master(foAppDrver,fbWtParent,fsBranchCd);
    ...
    @Override
    public Sales_Executive_Master getModel() {
        return poController;
    }
