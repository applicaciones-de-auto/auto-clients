...
import org.guanzon.auto.controller.clients.Service_Advisor_Master;
 ...
 * @author Arsiela
 */
public class Service_Advisor implements GRecord {
    ...
    Service_Advisor_Master poController;

    public Service_Advisor(GRider foAppDrver, boolean fbWtParent, String fsBranchCd) {
        poController = new Service_Advisor_Master(foAppDrver, fbWtParent, fsBranchCd);
    ...
    @Override
    public Service_Advisor_Master getModel() {
        return poController;
    }
    ...
    public JSONObject validateExistingSA() {
        return poController.validateExistingSA();
    }
