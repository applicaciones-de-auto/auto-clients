...
public class ServiceMechanicTest {
    static Service_Mechanic model;
    JSONObject json;
    boolean result;
    
    public ServiceMechanicTest(){}
    ...
    public static void setUpClass() {   
        ...
        model = new Service_Mechanic(instance,false, instance.getBranchCode());
    }
...
//            json = model.getModel().getModel().setClientID("A00118000001");
...
//                System.exit(1);
//            }
//            json = model.getModel().getModel().setTchSkill("y");
//            if ("error".equals((String) json.get("result"))){
//                System.err.println((String) json.get("message"));
//                System.exit(1);
//            }
